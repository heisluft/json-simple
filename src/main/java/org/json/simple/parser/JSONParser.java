...
public class JSONParser {
	 ...
	 * 		Use this factory to create your own JSON object and JSON array containers.
	 *
	 ...
	 * 		if there is a problem with the parsed object
	 */
	 ...
	 * 		the handler to handle the input
	 * @param isResume
	 * 		Indicates if it continues previous parsing operation. If set to true, resume parsing the old stream, and
	 * 		parameter 'in' will be ignored. If this method is called for the first time in this instance, isResume
	 * 		will be
	 * 		ignored.
	 *
	 * @throws IOException
