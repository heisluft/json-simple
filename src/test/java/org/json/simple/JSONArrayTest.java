...
public class JSONArrayTest extends TestCase {
	...
	public void testLongArrayToString() throws IOException {
		...
		assertEquals("[-7,22,9223372036854775807,-99]",
	...
	public void testObjectArrayToString() throws IOException {
		...
		assertEquals("[\"Hello\",12,[1,2,3]]", JSONArray.toJSONString(new Object[]{"Hello", 12, new int[]{1, 2, 3}}));
		...
		writer = new StringWriter();
		JSONArray.writeJSONString(new Object[]{"Hello", 12, new int[]{1, 2, 3}}, writer);
